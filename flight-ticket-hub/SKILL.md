---
name: flightAI
description: AI机票助手 - 实现国内航班搜索、舱位查询、预订下单、机票改期、机票退票。适用于用户询问航班、查询机票价格、提交机票订单、改期航班、退票时使用。
version: 1.0.0
metadata: {"codex": {"emoji": "✈️", "category": "travel", "tags": ["机票", "航班", "预订", "改期", "退票"], "requires": {"bins": ["python3"]}, "required": true}}
---
