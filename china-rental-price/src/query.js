...
import { normalizeTransitScene } from "./onehai-policy.js";
...
export function normalizeQuery(input) {
  ...
  const pickupDateTime = normalizeDateTime(input.pickupDateTime, "pickupDateTime");
  const dropoffDateTime = normalizeDateTime(input.dropoffDateTime, "dropoffDateTime");
